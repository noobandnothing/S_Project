...
class TubeSegmentationModel:
    ...
    def predict_and_crop_exact_shape_obj(self, image_path, output_dir=None, threshold=0.5, 
                                   padding=10, transparent_background=True, 
                                   edge_smoothing=True, feather_edges=2):
        original_image = Image.open(image_path).convert('RGB')
        original_size = original_image.size
    ...
    def predict_and_crop_exact_shape_obj_pil_dirrect(self, original_image, output_dir=None, threshold=0.5, 
                                   padding=10, transparent_background=True, 
                                   edge_smoothing=True, feather_edges=2):
        original_size = original_image.size
